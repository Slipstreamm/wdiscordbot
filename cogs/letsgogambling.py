...
class EconomyCog(commands.Cog):
    ...
    # Create a slash command group called "gambling"
    gambling_group = app_commands.Group(name="gambling", description="Gambling and economy commands")

    @gambling_group.command(name="work", description="Work a job and earn money!")
    ...
    @gambling_group.command(name="sell", description="Sell an item from your inventory.")
    ...
    @gambling_group.command(name="steal", description="Attempt to steal money from another user!")
    ...
    @gambling_group.command(name="shop", description="View shop items or buy an item.")
    ...
    @gambling_group.command(name="gamble", description="Gamble a certain amount of money in a coin flip!")
...
async def setup(bot: commands.Bot):
    ...
    # The gambling_group is automatically registered when the cog is added.
    # Explicitly adding it again with bot.tree.add_command() would cause CommandAlreadyRegistered.
